      ...
      <div class="col-md-5 col-lg-5 p-5 bg-body-tertiary border rounded-3">
        ...
        <div class="col-12">
            ...
            <div class="col-12">
              ...
              <select class="form-select" id="payment_date" name="payment_date" >
